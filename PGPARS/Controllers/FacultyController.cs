...
namespace PGPARS.Controllers
{
    public class FacultyController : Controller
    {
        ...
        public FacultyController(IApplicantRepository applicantRepository, IFundingRepository fundingRepository, IReviewRepository reviewRepository, IAuditRepository auditRepository)
        {
